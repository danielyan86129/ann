    ...
    double std_dev)    // standard deviation within clusters
{
    ...
    if (clusters == NULL || new_clust)
    {                                // need new cluster centers
