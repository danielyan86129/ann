...
//		one for splitting nodes and one for leaves. When a splitting
//node 		is visited, we determine which child to continue the search on 		(the
//closer one), and insert the other child into the priority 		queue.  When a leaf
//is visited, we compute the distances to the 		points in the buckets, and update
...
//
//		This is virtually identical to the ann_search for standard
//search.
//----------------------------------------------------------------------
